    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div >
            ...
            Easily bring your ideas to life with our AI image generator.
          ...
          <p className="text-sm sm:text-base text-gray-600 leading-relaxed max-w-lg">
            ...
            high-quality images in seconds. From product visuals and character
            designs to portraits and creative concepts that don’t yet exist,
            everything can be visualized effortlessly.
          </p>
        </div>
      </div>
    </motion.div>
